...
func (m *RETURN_DATA) GetVALUE() string {
	if m != nil {
		return m.VALUE
	}
	return ""
...
type Container_RequestPing struct {
	RequestPing *REQUEST_PING `protobuf:"bytes,3,opt,name=request_ping,json=requestPing,proto3,oneof"`
}

type Container_RequestContact struct {
	RequestContact *REQUEST_CONTACT `protobuf:"bytes,4,opt,name=request_contact,json=requestContact,proto3,oneof"`
}

type Container_RequestData struct {
	RequestData *REQUEST_DATA `protobuf:"bytes,5,opt,name=request_data,json=requestData,proto3,oneof"`
}

type Container_RequestStore struct {
	RequestStore *REQUEST_STORE `protobuf:"bytes,6,opt,name=request_store,json=requestStore,proto3,oneof"`
}

type Container_ReturnPing struct {
	ReturnPing *RETURN_PING `protobuf:"bytes,7,opt,name=return_ping,json=returnPing,proto3,oneof"`
}

type Container_ReturnContacts struct {
	ReturnContacts *RETURN_CONTACTS `protobuf:"bytes,8,opt,name=return_contacts,json=returnContacts,proto3,oneof"`
}

type Container_ReturnData struct {
	ReturnData *RETURN_DATA `protobuf:"bytes,9,opt,name=return_data,json=returnData,proto3,oneof"`
}

type Container_ReturnStore struct {
	ReturnStore *RETURN_STORE `protobuf:"bytes,10,opt,name=return_store,json=returnStore,proto3,oneof"`
}
...
func _Container_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*Container)
	switch tag {
	case 3: // attachment.request_ping
		...
		return true, err
	case 4: // attachment.request_contact
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		...
		return true, err
	case 5: // attachment.request_data
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		...
		return true, err
	case 6: // attachment.request_store
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
	...
	case 7: // attachment.return_ping
		...
		return true, err
	case 8: // attachment.return_contacts
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
	...
	case 9: // attachment.return_data
		...
		return true, err
	case 10: // attachment.return_store
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
...
var fileDescriptor_e9a1501f19acc56d = []byte{
	...
	,
}
